  ...
  return (
    <div className="flex min-h-screen flex-col bg-black">
      ...
      <main className="flex-1">
        ...
        <section className="py-32 px-6 relative">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {[
                { name: "New York City", slug: "new-york", count: "12,000+", gradient: "from-blue-500/10 to-cyan-500/10" },
                { name: "Miami", slug: "miami", count: "8,500+", gradient: "from-orange-500/10 to-rose-500/10" },
                { name: "Los Angeles", slug: "la", count: "10,000+", gradient: "from-purple-500/10 to-pink-500/10" },
                { name: "Chicago", slug: "chicago", count: "7,800+", gradient: "from-emerald-500/10 to-teal-500/10" },
                { name: "Austin", slug: "austin", count: "5,200+", gradient: "from-amber-500/10 to-yellow-500/10" },
                { name: "San Francisco", slug: "sf", count: "4,500+", gradient: "from-indigo-500/10 to-blue-500/10" },
              ].map((city) => (
                <Link
                  key={city.slug}
                  href={`/search?city=${city.slug}`}
                  className="group relative p-8 rounded-2xl bg-white/[0.02] backdrop-blur-xl border border-white/[0.06] hover:border-white/[0.12] hover:bg-white/[0.04] transition-all duration-500 overflow-hidden"
                >
                  {/* Hover gradient */}
                  <div className={`absolute inset-0 bg-gradient-to-br ${city.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
                  <div className="relative">
                  ...
                  <ArrowRight className="absolute top-8 right-8 h-5 w-5 text-white/20 group-hover:text-white/60 group-hover:translate-x-1 transition-all duration-300" />
                </Link>
              ))}
            </div>
          </div>
        ...
        <section className="py-32 px-6 relative">
          {/* Background glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-purple-500/10 rounded-full blur-[100px]" />

          <div className="relative max-w-2xl mx-auto">
            {/* Glass card CTA */}
            <div className="p-12 rounded-3xl bg-white/[0.02] backdrop-blur-xl border border-white/[0.08] text-center">
              ...
              <Link
                href="/search"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-white text-black font-medium hover:bg-white/90 hover:shadow-lg hover:shadow-white/20 transition-all duration-300"
              >
                Get started
                <ArrowRight className="h-4 w-4" />
              </Link>
