...
module.exports = [
  {
    ...
    ticker: ["Topped out 2025","400 residences","41 stories","160k sq ft Class A office","Delivering late 2026"],
    stats: [["400","Residences"],["41","Stories"],["Late '26","Completion"],["160k","Sq Ft Office"]],
    kicker: "2626 Biscayne Boulevard",
    ...
    body: [
      ...
      "Designed by Arquitectonica, the tower stacks 400 rental residences over roughly 160,000 square feet of Class A office and 15,000 square feet of ground-floor retail — a genuine live-work building rather than a marketing phrase."
    ],
    cards: [
      ["Edgewater without the wait","Most new Edgewater towers are condos. This one is purpose-built rental, so you lease from one operator instead of chasing individual owners."],
      ["Office downstairs","160,000 sq ft of Class A office in the same building — the shortest commute in Miami for anyone whose employer takes space here."],
      ["Bayfront blocks","Margaret Pace Park, the Venetian Causeway and the bay walk are all within a few minutes on foot."]
    ],
    faq: [
      ["When does 2600 Biscayne start leasing?","The tower topped out in 2025 and is tracking to completion in late 2026. Applications typically open near completion — waitlist members hear the day pricing is released."],
      ["How much will rent be?","Not yet published. Edgewater new construction currently runs roughly $3,000–5,500 depending on size and floor. Exact pricing goes to the waitlist first."],
      ["Where exactly is it?","2626 Biscayne Boulevard, also addressed at 246 NE 26th Terrace, in Miami's Edgewater neighborhood."],
      ["Who is the developer?","Oak Row Equities, with architecture by Arquitectonica — the firm behind much of the modern Miami skyline."]
    ],
